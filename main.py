...
def get_args_parser():
    ...
    # Model parameters
    parser.add_argument('--model', default='RepLKNet_CGS', type=str, metavar='MODEL',
    ...
    # Dataset parameters
    parser.add_argument('--data_path', default="/datasets/ImageNet-1K/", type=str,
                        help='dataset path')
    ...
    parser.add_argument('--output_dir', default='/CGS/output',
...
def main(args):
    ...
    #   ================================================== build model ================================ #
    if args.model == 'RepLKNet_CGS':
        model = create_RepLKNet_CGS(drop_path_rate=args.drop_path, num_classes=args.nb_classes, use_checkpoint=args.use_checkpoint,
