...
# # Large
# from CGS import DepthWiseSharing_v4, PointWiseSharing_v6_1, PointWiseSharing_v6_2

# # Small
# from CGS import DepthWiseSharing_v5, PointWiseSharing_v7_1, PointWiseSharing_v7_2

# Base
from CGS import DepthWiseSharing_v3, PointWiseSharing_v5_1, PointWiseSharing_v5_2
...
def get_conv2d(in_channels, out_channels, kernel_size, stride, padding, dilation, groups, bias):
    ...
    if(True == use_large_impl):
        ...
        return DepthWiseSharing_v3(in_channels = in_channels, kernel_size = kernel_size, 
...
class RepLKBlock_sharing_v2(nn.Module):
    def __init__(self, channels, dw_channels, block_lk_size, small_kernel, drop_path, small_kernel_merged=False, R=200):
        super().__init__()
        self.block_pw1 = PointWiseSharing_v5_1(channels, dw_channels, 1, 1, 0, groups=1, R=R)
        self.block_pw2 = PointWiseSharing_v5_2(dw_channels, channels, 1, 1, 0, groups=1, R=R)
